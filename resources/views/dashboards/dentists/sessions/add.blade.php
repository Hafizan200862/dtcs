...
<section class="content">
    ...
    <div class="card card-primary">
        ...
        <form method="POST" action="{{ route('dentistStoreSessionForm') }}" enctype="multipart/form-data">
            @csrf
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row">
                    <input type="hidden" name="appointment_id" value="{{ $session->id }}">
                    <input type="hidden" name="patient_id" value="{{ $session->patient->id }}">
                    ...
                    <table class="table" id="table-tooth">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="teeth_remark" name="teeth_remark[]" class="form-control"/>
                                </td>
...
<script>
    ...
    // add row tooth table
    $('#table-tooth thead').on('click','.addRow', function(){
        var tr = "<tr>"+
                    "<td>"+
                        "<select id='teeth' name='teeth[]'  class='form-control'>"+
                            "@foreach($teeth as $id => $tooth)"+
        ...
        $('#table-tooth tbody').append(tr);
    });
    // delete row tooth table
    $('#table-tooth tbody').on('click','.deleteRow', function(){
