                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control select2bs4" style="width: 100%;" readonly
                                    name="patient_id" value="{{ $appointmentSession->patient_id }}">
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>{{ __('Phone') }}</label>
                                <input class="form-control select2bs4" style="width: 100%;" disabled="disabled"
                                    name="phone">
                            </div>
                            <!-- /.form-group -->
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <div class="form-group">
                                <label>Gender</label>
                                <input class="form-control select2bs4" style="width: 100%;" disabled="disabled" name="">
                            </div> --}}
                            <!-- /.form-group -->
                        </div>
                        <!-- /.col -->
                    ...
                    <div class="col-md-6">
                        <div class="tooth-chart">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 450 700"
...
@section('script')
    ...
    <script>
        ...
        teeth.forEach(tooth => {
            context.beginPath();
            context.arc(tooth.x, tooth.y, 20, 0, 2 * Math.PI);
            context.stroke();

            context.font = '14px sans-serif';
            context.textAlign = 'center';
            context.fillText(tooth.number, tooth.x, tooth.y);
        });

        canvas.addEventListener('click', event => {
            const x = event.offsetX;
            const y = event.offsetY;
            const clickedTooth = teeth.find(tooth => {
                return (x >= tooth.x - 20 && x <= tooth.x + 20) && (y >= tooth.y - 20 && y <= tooth.y + 20);
            });
            if (clickedTooth) {
                // Update the page with information about the clicked tooth
                document.getElementById('tooth-number').textContent = clickedTooth.number;
            }
        });
    </script>
    <!-- SCRIPTS END-->
