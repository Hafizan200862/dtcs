        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                    <a href="{{ route('admin.dentist') }}" type="button" class="btn btn-primary">Back</a>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('adminAddDentist') }}" method="post">
                        ...
                        <div class="card-body">
                            {{-- <div class="form-group">
                                ...
                                <input type="ic" class="form-control" name="ic" placeholder="Enter IC No" value="{{ old('ic') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="phone" class="form-control" name="phone" placeholder="Enter Phone No" value="{{ old('phone') }}">
